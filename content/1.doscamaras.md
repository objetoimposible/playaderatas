...
![mapa basura espacial ](image/005.png) https://stuffin-space.vader.zone
...
1. codigo para extraccion de videos desde URL (Sonda Magallanes) wget -r -np -nH --cut-dirs=4 -e robots=off --no-check-certificate --user-agent="Mozilla/5.0" --accept="*.jpg,*.jpeg,*.png,*.tif" https://pds-geosciences.wustl.edu/mgn/urn-nasa-pds-magellan_midr/browse/fmidr/
